...
public class BookMark extends AbstractDataProvider.Data {
    ...
    public String title, summary, content, time, book_title, book_cover, nickname;
    public BookMark(int mid, String title, String summary, String content, String time, int bid, String book_title, String book_cover, int uid, String nickname) {
        this.mid = mid;
        this.title = title;
